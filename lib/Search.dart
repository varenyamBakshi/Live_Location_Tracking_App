    ...
    return new TextField(
      ...
      onChanged: (text) {
        ...
        setState(() {
          ...
          if (element['full_name'] != _username) { // if the current document is not of the current user

            if (!_usernames.contains(element['full_name'])) {  // if _usernames list doesn't contain this
              _usernames.insert(i, element['full_name']);       // add it

              if (_selectedusernames.contains(element['full_name'])) {  // if this element user is in _selectedusernames update the map accordingly
